...
public class MeasurementPreparedStatementSetter implements PreparedStatementSetter {
    ...
    public void setValues(PreparedStatement ps) throws SQLException {
        ...
        psWrapper.setString(48, () -> {
            return agentInfo.getType().name();
        });
        ...
        if (computedNetworkInfo != null) {
            ...
            psWrapper.setInt(28, () -> {
                return Integer.parseInt(computedNetworkInfo.getNetworkOperatorMccMnc().split("-")[0]);
            });
            psWrapper.setInt(29, () -> {
                return Integer.parseInt(computedNetworkInfo.getNetworkOperatorMccMnc().split("-")[1]);
            });
            ...
            psWrapper.setInt(32, () -> {
                return Integer.parseInt(computedNetworkInfo.getSimOperatorMccMnc().split("-")[0]);
            });
            psWrapper.setInt(33, () -> {
                return Integer.parseInt(computedNetworkInfo.getSimOperatorMccMnc().split("-")[1]);
            });
        ...
        if (signalList != null && signalList.size() > 0) {
            ...
            psWrapper.setObject(53, () -> {
                return signalInfo.getCellInfo().getFrequency();
            });
